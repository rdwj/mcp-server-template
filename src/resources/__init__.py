...
All resource modules in this directory are automatically discovered and imported.
FastMCP decorators (@mcp.resource) register resources when modules are imported.
